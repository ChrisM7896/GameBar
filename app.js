...
app.get('/', isAuthenticated, (req, res) => {
    ...
    db.get('SELECT gp FROM users WHERE username = ?', [req.session.user], (err, row) => {
        if (err) {
            ...
            res.render('index', { user: req.session.user, gp: req.session.gp, pageName: 'Gamebar', version: 'v0.3.5' });
        }
    });
...
app.get('/changes', isAuthenticated, (req, res) => {
    res.render('changes', { user: req.session.user, gp: req.session.gp, pageName: 'Gamebar', version: 'v0.3.5' });
});
...
app.get('/2048', isAuthenticated, (req, res) => {
    ...
    res.render('page', { user: req.session.user, gp: req.session.gp, cost: 45, pageName: 'Gamebar', version: 'v0.3.5', data: data });
});
...
app.get('/snake', isAuthenticated, (req, res) => {
    ...
    res.render('page', { user: req.session.user, gp: req.session.gp, cost: 25, pageName: 'Gamebar', version: 'v0.3.5', data: data });
}
);
...
app.get('/stack', isAuthenticated, (req, res) => {
    ...
    res.render('page', { user: req.session.user, gp: req.session.gp, cost: 30, pageName: 'Gamebar', version: 'v0.3.5', data: data });
}
);
...
app.get('/alchemy', isAuthenticated, (req, res) => {
    ...
    res.render('page', { user: req.session.user, gp: req.session.gp, cost: 799, pageName: 'Gamebar', version: 'v0.3.5', data: data });
});
...
app.get('/wordle', isAuthenticated, (req, res) => {
    ...
    res.render('page', { user: req.session.user, gp: req.session.gp, cost: 20, pageName: 'Gamebar', version: 'v0.3.5', data: data });
});
